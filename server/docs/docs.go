...
const docTemplate = `{
    ...
    "paths": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/data.PaymentMethodVO"
                                            }
                                        }
                                    }
                                }
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/data.AddPaymentMethodResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/payment-ms/v1/web/transactions/{payment_id}": {
            "get": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/data.TransactionVO"
                                        }
                                    }
                                }
                            ]
